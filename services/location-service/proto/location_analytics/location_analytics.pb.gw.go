...
/*
Package location_analytics is a reverse proxy.
...
func request_AnalyticsService_GetAnalyticsById_0(ctx context.Context, marshaler runtime.Marshaler, client AnalyticsServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq GetAnalyticsByIdRequest
	...
	msg, err := client.GetAnalyticsById(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err
}

func local_request_AnalyticsService_GetAnalyticsById_0(ctx context.Context, marshaler runtime.Marshaler, server AnalyticsServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq GetAnalyticsByIdRequest
		metadata runtime.ServerMetadata
		err      error
	...
	msg, err := server.GetAnalyticsById(ctx, &protoReq)
	return msg, metadata, err
}
...
func RegisterAnalyticsServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server AnalyticsServiceServer) error {
	mux.Handle(http.MethodGet, pattern_AnalyticsService_GetAnalyticsById_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/location_analytics.AnalyticsService/GetAnalyticsById", runtime.WithHTTPPathPattern("/v1/analytics/{location_id}/period/{period}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_AnalyticsService_GetAnalyticsById_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_AnalyticsService_GetAnalyticsById_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	})
...
func RegisterAnalyticsServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client AnalyticsServiceClient) error {
	mux.Handle(http.MethodGet, pattern_AnalyticsService_GetAnalyticsById_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/location_analytics.AnalyticsService/GetAnalyticsById", runtime.WithHTTPPathPattern("/v1/analytics/{location_id}/period/{period}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_AnalyticsService_GetAnalyticsById_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_AnalyticsService_GetAnalyticsById_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3, 1, 0, 4, 1, 5, 3}, []string{"v1", "analytics", "location_id", "period"}, ""))
)

var (
	forward_AnalyticsService_GetAnalyticsById_0 = runtime.ForwardResponseMessage
)
